...
namespace OPME.StockManagement.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SupplierConfigurations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    MesesPlanejamento = table.Column<int>(type: "INTEGER", nullable: false),
                    MesesMinimos = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierConfigurations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupplierConfigurations_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockOutputs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CodigoProduto",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockOutputs_DataSaida",
                table: "StockOutputs",
                column: "DataSaida");

            migrationBuilder.CreateIndex(
                name: "IX_StockOutputs_ProductId",
                table: "StockOutputs",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierConfigurations_SupplierId",
                table: "SupplierConfigurations",
                column: "SupplierId",
                unique: true);
